...
export default {
  ...
  effects: {
    ...
    *update({ payload }, { call, put }) {
      ...
      const result = yield call(addressService.schoolUpdate, id, data)
      if(result.status == 'OK') {
        yield put({
          type: 'list',
          payload: {
    ...
    *add({ payload }, { call, put }) {
      const result = yield call(addressService.schoolAdd, payload.data)
      if(result.status == 'OK') {
        yield put({
          type: 'list',
          payload: {
    ...
    *delete({ payload }, { call, put }) {
      const result = yield call(addressService.schoolDelete, payload.id)
      if(result.status == 'OK') {
