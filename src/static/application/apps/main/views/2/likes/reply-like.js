...
class ReplyLikes extends Component {
  ...
  componentDidMount() {
    const replyId = this.props.match.params.replyId
    this.props.dispatch({
      type: 'likes/reply',
      payload: {
        data: replyId
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      const replyId = Number(this.props.match.params.replyId)
      if(!err) {
        this.props.dispatch({
...
export default connect(mapStateToProps)(Form.create()(ReplyLikes))
